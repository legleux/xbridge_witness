...
set(min_gcc_version "11.4")
set(min_clang_version "13")
set(min_apple_clang_version "15.0")
...
elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
  ...
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${min_gcc_version})
    message(FATAL_ERROR "This project requires GCC ${min_gcc_version} or later")
  endif()
endif()

if(CMAKE_GENERATOR STREQUAL "Xcode") # TODO: Test this
  set(is_xcode TRUE)
endif()
...
if(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
  message(FATAL_ERROR "64 bit target architecture required")
endif()
